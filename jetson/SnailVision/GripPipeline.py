...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [45.32374100719424, 164.71986417657047]
        self.__hsv_threshold_saturation = [0.0, 62.34295415959252]
        self.__hsv_threshold_value = [231.93360565784658, 255.0]
        ...
        self.__filter_contours_solidity = [86.33093525179856, 100]
    ...
    def process(self, source0):
        ...
        try:
            with open("calibration/fisheyecalibration.txt") as json_file:
                ...
                D=np.array(calibration['D'])
                source0 = undistort(source0, DIM, K, D)
        except:
            print("Could not read fisheyecalibration.txt")
    ...
    def __find_contours(input, external_only):
        ...
        contours, hierarchy = cv2.findContours(input, mode=mode, method=method)[-2:]
        return contours
    ...
    def __filter_contours(input_contours, min_area, min_perimeter, min_width, max_width,
        ...
        for contour in input_contours:
            ...
            solid = 0 if hullArea == 0 else 100 * area / hullArea
