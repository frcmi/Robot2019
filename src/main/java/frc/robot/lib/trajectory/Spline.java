...
public class Spline {
  ...
  public static boolean reticulateSplines(double x0, double y0, double theta0,
    ...
    double theta0_hat = SnailMath.getDifferenceInAngleRadians(
            result.theta_offset_, theta0);
    double theta1_hat = SnailMath.getDifferenceInAngleRadians(
    ...
    if (Math.abs(SnailMath.getDifferenceInAngleRadians(theta0_hat,
            theta1_hat))
            >= Math.PI / 2) {
      return false;
    }
